...
Los tweets que obtenemos pertenecen a un mismo día y son publicados aproximadamente durante una hora. En la siguiente gráfica se muestran las publicaciones para iPhone, iPad y Android. 
```{r}
library(lubridate)
library(scales)
tweets_iph_an_ipa %>%
  count(source, hour = created) %>%
